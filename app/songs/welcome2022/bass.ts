import { createPatterns, createStep, mapToNoteStep, NoteStep, NoteStepMappable, Step } from '../../../lib/aira';
...
const [ a1, a2, d1, d2, e1, e2, f1, f2 ] = noteStepData.map(
  (n: NoteStepMappable): NoteStep => mapToNoteStep(n)
).map(
  (n: NoteStep): Step => createStep(n)
);
