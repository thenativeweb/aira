...
suite('Chord', (): void => {
  ...
  test('chord C in first inversion is written C/E.', async (): Promise<void> => {
    const root = new Note('C', 0);
    const { chordName } = new GenericChord(root, { quality: 'Maj', inversion: 1 });
  ...
  test('chord Emin(addb6)(no5) is written Emadd♭6(no5).', async (): Promise<void> => {
    ...
    const { chordName } = new GenericChord(root, { quality: 'min', additions: [ 'b6' ], omissions: [ 5 ]});
  ...
  test('chord C7 is written C7.', async (): Promise<void> => {
    const root = new Note('C', 0);
    const { chordName } = new GenericChord(root, { quality: 'Dom', extensions: [ 7 ]});
  ...
  test('chord CAug is written C+.', async (): Promise<void> => {
    const root = new Note('C', 0);
    const { chordName } = new GenericChord(root, { quality: 'Aug' });
    const expectedChordName = 'C+';
  ...
  test('chord ChalfDim7 is written Cø7.', async (): Promise<void> => {
    const root = new Note('C', 0);
    const { chordName } = new GenericChord(root, { quality: 'halfDim', extensions: [ 7 ]});
  ...
  test('chord Csus2 is written Csus2.', async (): Promise<void> => {
    const root = new Note('C', 0);
    const { chordName } = new GenericChord(root, { quality: 'sus', suspension: 2 });
  ...
  test('chord Csus4 is written Csus4.', async (): Promise<void> => {
    const root = new Note('C', 0);
    const { chordName } = new GenericChord(root, { quality: 'sus', suspension: 4 });
  ...
  test('chord C5 is written C5.', async (): Promise<void> => {
    const root = new Note('C', 0);
    const { chordName } = new GenericChord(root, { quality: 'Power' });
  ...
  test('chord C9 is written C9.', async (): Promise<void> => {
    const root = new Note('C', 0);
    const { chordName } = new GenericChord(root, { quality: 'Dom', extensions: [ 7, 9 ]});
  ...
  test('chord C11 is written C11.', async (): Promise<void> => {
    const root = new Note('C', 0);
    const { chordName } = new GenericChord(root, { quality: 'Dom', extensions: [ 7, 9, 11 ]});
  ...
  test('chord Cm11 is written Cm11.', async (): Promise<void> => {
    const root = new Note('C', 0);
    const { chordName } = new GenericChord(root, { quality: 'min', extensions: [ 7, 9, 11 ]});
  ...
  test('chord C13(no9,no11) is written C13(no9,no11).', async (): Promise<void> => {
    const root = new Note('C', 0);
    const { chordName } = new GenericChord(root, { quality: 'Dom', extensions: [ 7, 9, 11, 13 ], omissions: [ 9, 11 ]});
  ...
  test('chord C(#5) is written C(♯5).', async (): Promise<void> => {
    const root = new Note('C', 0);
    const { chordName } = new GenericChord(root, { quality: 'Maj', alterations: [ '#5' ]});
  ...
  test('chord Cadd9(#5,b9) is written Cadd9(♯5,♭9).', async (): Promise<void> => {
    const root = new Note('C', 0);
    const { chordName } = new GenericChord(root, { quality: 'Maj', alterations: [ '#5', '♭9' ], additions: [ 9 ]});
